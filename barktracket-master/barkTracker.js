...
function checkSoundLevels(){
  ...
  if(soundValue >= threshold){
    ...
    // Use the request library to hit the Sparkfun URL - make sure you replace the applicable parts with your data and remember to match &Field with sparkfun data Field
